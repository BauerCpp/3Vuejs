...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function Cu(){return new Wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function Pu(){return new Wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
...
}`;function EM(n,t,e){let i=new Zl;const s=new Ot,r=new Ot,o=new se,a=new z_({depthPacking:$m}),l=new H_,c={},u=e.maxTextureSize,h={[Gn]:ze,[ze]:Gn,[Mn]:Mn},d=new Wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ot},radius:{value:4}},vertexShader:MM,fragmentShader:SM}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ze;_.setAttribute("position",new yn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ee(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sf;let f=this.type;this.render=function(R,C,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const T=n.getRenderTarget(),y=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),tt=n.state;tt.setBlending(si),tt.buffers.color.setClear(1,1,1,1),tt.buffers.depth.setTest(!0),tt.setScissorTest(!1);const X=f!==Un&&this.type===Un,et=f===Un&&this.type!==Un;for(let st=0,$=R.length;st<$;st++){const Q=R[st],H=Q.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const ft=H.getFrameExtents();if(s.multiply(ft),r.copy(H.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ft.x),s.x=r.x*ft.x,H.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ft.y),s.y=r.y*ft.y,H.mapSize.y=r.y)),H.map===null||X===!0||et===!0){const ut=this.type!==Un?{minFilter:pn,magFilter:pn}:{};H.map!==null&&H.map.dispose(),H.map=new Pi(s.x,s.y,ut),H.map.texture.name=Q.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const Et=H.getViewportCount();for(let ut=0;ut<Et;ut++){const ht=H.getViewport(ut);o.set(r.x*ht.x,r.y*ht.y,r.x*ht.z,r.y*ht.w),tt.viewport(o),H.updateMatrices(Q,ut),i=H.getFrustum(),S(C,F,H.camera,Q,this.type)}H.isPointLightShadow!==!0&&this.type===Un&&A(H,F),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(T,y,I)};function A(R,C){const F=t.update(v);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Pi(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(C,null,F,d,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(C,null,F,p,v,null)}function b(R,C,F,T){let y=null;const I=F.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(I!==void 0)y=I;else if(y=F.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const tt=y.uuid,X=C.uuid;let et=c[tt];et===void 0&&(et={},c[tt]=et);let st=et[X];st===void 0&&(st=y.clone(),et[X]=st,C.addEventListener("dispose",L)),y=st}if(y.visible=C.visible,y.wireframe=C.wireframe,T===Un?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:h[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,F.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const tt=n.properties.get(y);tt.light=F}return y}function S(R,C,F,T,y){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===Un)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,R.matrixWorld);const X=t.update(R),et=R.material;if(Array.isArray(et)){const st=X.groups;for(let $=0,Q=st.length;$<Q;$++){const H=st[$],ft=et[H.materialIndex];if(ft&&ft.visible){const Et=b(R,ft,T,y);R.onBeforeShadow(n,R,C,F,X,Et,H),n.renderBufferDirect(F,null,X,Et,R,H),R.onAfterShadow(n,R,C,F,X,Et,H)}}}else if(et.visible){const st=b(R,et,T,y);R.onBeforeShadow(n,R,C,F,X,st,null),n.renderBufferDirect(F,null,X,st,R,null),R.onAfterShadow(n,R,C,F,X,st,null)}}const tt=R.children;for(let X=0,et=tt.length;X<et;X++)S(tt[X],C,F,T,y)}function L(R){R.target.removeEventListener("dispose",L);for(const F in c){const T=c[F],y=R.target.uuid;y in T&&(T[y].dispose(),delete T[y])}}}const yM={[La]:Ia,[Ua]:Oa,[Na]:Ba,[ds]:Fa,[Ia]:La,[Oa]:Ua,[Ba]:Na,[Fa]:ds};function bM(n,t){function e(){let N=!1;const Mt=new se;let J=null;const nt=new se(0,0,0,0);return{setMask:function(bt){J!==bt&&!N&&(n.colorMask(bt,bt,bt,bt),J=bt)},setLocked:function(bt){N=bt},setClear:function(bt,yt,Vt,he,Ae){Ae===!0&&(bt*=he,yt*=he,Vt*=he),Mt.set(bt,yt,Vt,he),nt.equals(Mt)===!1&&(n.clearColor(bt,yt,Vt,he),nt.copy(Mt))},reset:function(){N=!1,J=null,nt.set(-1,0,0,0)}}}function i(){let N=!1,Mt=!1,J=null,nt=null,bt=null;return{setReversed:function(yt){if(Mt!==yt){const Vt=t.get("EXT_clip_control");Mt?Vt.clipControlEXT(Vt.LOWER_LEFT_EXT,Vt.ZERO_TO_ONE_EXT):Vt.clipControlEXT(Vt.LOWER_LEFT_EXT,Vt.NEGATIVE_ONE_TO_ONE_EXT);const he=bt;bt=null,this.setClear(he)}Mt=yt},getReversed:function(){return Mt},setTest:function(yt){yt?gt(n.DEPTH_TEST):Ct(n.DEPTH_TEST)},setMask:function(yt){J!==yt&&!N&&(n.depthMask(yt),J=yt)},setFunc:function(yt){if(Mt&&(yt=yM[yt]),nt!==yt){switch(yt){case La:n.depthFunc(n.NEVER);break;case Ia:n.depthFunc(n.ALWAYS);break;case Ua:n.depthFunc(n.LESS);break;case ds:n.depthFunc(n.LEQUAL);break;case Na:n.depthFunc(n.EQUAL);break;case Fa:n.depthFunc(n.GEQUAL);break;case Oa:n.depthFunc(n.GREATER);break;case Ba:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}nt=yt}},setLocked:function(yt){N=yt},setClear:function(yt){bt!==yt&&(Mt&&(yt=1-yt),n.clearDepth(yt),bt=yt)},reset:function(){N=!1,J=null,nt=null,bt=null,Mt=!1}}}function s(){let N=!1,Mt=null,J=null,nt=null,bt=null,yt=null,Vt=null,he=null,Ae=null;return{setTest:function(ee){N||(ee?gt(n.STENCIL_TEST):Ct(n.STENCIL_TEST))},setMask:function(ee){Mt!==ee&&!N&&(n.stencilMask(ee),Mt=ee)},setFunc:function(ee,nn,An){(J!==ee||nt!==nn||bt!==An)&&(n.stencilFunc(ee,nn,An),J=ee,nt=nn,bt=An)},setOp:function(ee,nn,An){(yt!==ee||Vt!==nn||he!==An)&&(n.stencilOp(ee,nn,An),yt=ee,Vt=nn,he=An)},setLocked:function(ee){N=ee},setClear:function(ee){Ae!==ee&&(n.clearStencil(ee),Ae=ee)},reset:function(){N=!1,Mt=null,J=null,nt=null,bt=null,yt=null,Vt=null,he=null,Ae=null}}}const r=new e,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},h={},d=new WeakMap,p=[],_=null,v=!1,m=null,f=null,A=null,b=null,S=null,L=null,R=null,C=new kt(0,0,0),F=0,T=!1,y=null,I=null,tt=null,X=null,et=null;const st=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,Q=0;const H=n.getParameter(n.VERSION);H.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(H)[1]),$=Q>=1):H.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),$=Q>=2);let ft=null,Et={};const ut=n.getParameter(n.SCISSOR_BOX),ht=n.getParameter(n.VIEWPORT),Rt=new se().fromArray(ut),q=new se().fromArray(ht);function rt(N,Mt,J,nt){const bt=new Uint8Array(4),yt=n.createTexture();n.bindTexture(N,yt),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Vt=0;Vt<J;Vt++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(Mt,0,n.RGBA,1,1,nt,0,n.RGBA,n.UNSIGNED_BYTE,bt):n.texImage2D(Mt+Vt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,bt);return yt}const pt={};pt[n.TEXTURE_2D]=rt(n.TEXTURE_2D,n.TEXTURE_2D,1),pt[n.TEXTURE_CUBE_MAP]=rt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[n.TEXTURE_2D_ARRAY]=rt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),pt[n.TEXTURE_3D]=rt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),gt(n.DEPTH_TEST),o.setFunc(ds),Y(!1),K(Vc),gt(n.CULL_FACE),M(si);function gt(N){u[N]!==!0&&(n.enable(N),u[N]=!0)}function Ct(N){u[N]!==!1&&(n.disable(N),u[N]=!1)}function Yt(N,Mt){return h[N]!==Mt?(n.bindFramebuffer(N,Mt),h[N]=Mt,N===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=Mt),N===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=Mt),!0):!1}function Pt(N,Mt){let J=p,nt=!1;if(N){J=d.get(Mt),J===void 0&&(J=[],d.set(Mt,J));const bt=N.textures;if(J.length!==bt.length||J[0]!==n.COLOR_ATTACHMENT0){for(let yt=0,Vt=bt.length;yt<Vt;yt++)J[yt]=n.COLOR_ATTACHMENT0+yt;J.length=bt.length,nt=!0}}else J[0]!==n.BACK&&(J[0]=n.BACK,nt=!0);nt&&n.drawBuffers(J)}function ue(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const w={[Si]:n.FUNC_ADD,[Em]:n.FUNC_SUBTRACT,[ym]:n.FUNC_REVERSE_SUBTRACT};w[bm]=n.MIN,w[Tm]=n.MAX;const P={[Am]:n.ZERO,[wm]:n.ONE,[Rm]:n.SRC_COLOR,[Pa]:n.SRC_ALPHA,[Um]:n.SRC_ALPHA_SATURATE,[Lm]:n.DST_COLOR,[Pm]:n.DST_ALPHA,[Cm]:n.ONE_MINUS_SRC_COLOR,[Da]:n.ONE_MINUS_SRC_ALPHA,[Im]:n.ONE_MINUS_DST_COLOR,[Dm]:n.ONE_MINUS_DST_ALPHA,[Nm]:n.CONSTANT_COLOR,[Fm]:n.ONE_MINUS_CONSTANT_COLOR,[Om]:n.CONSTANT_ALPHA,[Bm]:n.ONE_MINUS_CONSTANT_ALPHA};function M(N,Mt,J,nt,bt,yt,Vt,he,Ae,ee){if(N===si){v===!0&&(Ct(n.BLEND),v=!1);return}if(v===!1&&(gt(n.BLEND),v=!0),N!==Sm){if(N!==m||ee!==T){if((f!==Si||S!==Si)&&(n.blendEquation(n.FUNC_ADD),f=Si,S=Si),ee)switch(N){case cs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gc:n.blendFunc(n.ONE,n.ONE);break;case kc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Wc:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case cs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gc:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case kc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Wc:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}A=null,b=null,L=null,R=null,C.set(0,0,0),F=0,m=N,T=ee}return}bt=bt||Mt,yt=yt||J,Vt=Vt||nt,(Mt!==f||bt!==S)&&(n.blendEquationSeparate(w[Mt],w[bt]),f=Mt,S=bt),(J!==A||nt!==b||yt!==L||Vt!==R)&&(n.blendFuncSeparate(P[J],P[nt],P[yt],P[Vt]),A=J,b=nt,L=yt,R=Vt),(he.equals(C)===!1||Ae!==F)&&(n.blendColor(he.r,he.g,he.b,Ae),C.copy(he),F=Ae),m=N,T=!1}function it(N,Mt){N.side===Mn?Ct(n.CULL_FACE):gt(n.CULL_FACE);let J=N.side===ze;Mt&&(J=!J),Y(J),N.blending===cs&&N.transparent===!1?M(si):M(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const nt=N.stencilWrite;a.setTest(nt),nt&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ot(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?gt(n.SAMPLE_ALPHA_TO_COVERAGE):Ct(n.SAMPLE_ALPHA_TO_COVERAGE)}function Y(N){y!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),y=N)}function K(N){N!==xm?(gt(n.CULL_FACE),N!==I&&(N===Vc?n.cullFace(n.BACK):N===Mm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Ct(n.CULL_FACE),I=N}function Z(N){N!==tt&&($&&n.lineWidth(N),tt=N)}function ot(N,Mt,J){N?(gt(n.POLYGON_OFFSET_FILL),(X!==Mt||et!==J)&&(n.polygonOffset(Mt,J),X=Mt,et=J)):Ct(n.POLYGON_OFFSET_FILL)}function j(N){N?gt(n.SCISSOR_TEST):Ct(n.SCISSOR_TEST)}function x(N){N===void 0&&(N=n.TEXTURE0+st-1),ft!==N&&(n.activeTexture(N),ft=N)}function g(N,Mt,J){J===void 0&&(ft===null?J=n.TEXTURE0+st-1:J=ft);let nt=Et[J];nt===void 0&&(nt={type:void 0,texture:void 0},Et[J]=nt),(nt.type!==N||nt.texture!==Mt)&&(ft!==J&&(n.activeTexture(J),ft=J),n.bindTexture(N,Mt||pt[N]),nt.type=N,nt.texture=Mt)}function D(){const N=Et[ft];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function z(){try{n.compressedTexImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function k(){try{n.compressedTexImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function V(){try{n.texSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function dt(){try{n.texSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function at(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function mt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function It(){try{n.texStorage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function lt(){try{n.texStorage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function xt(){try{n.texImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function wt(){try{n.texImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ut(N){Rt.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),Rt.copy(N))}function _t(N){q.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),q.copy(N))}function Nt(N,Mt){let J=c.get(Mt);J===void 0&&(J=new WeakMap,c.set(Mt,J));let nt=J.get(N);nt===void 0&&(nt=n.getUniformBlockIndex(Mt,N.name),J.set(N,nt))}function zt(N,Mt){const nt=c.get(Mt).get(N);l.get(Mt)!==nt&&(n.uniformBlockBinding(Mt,nt,N.__bindingPointIndex),l.set(Mt,nt))}function oe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ft=null,Et={},h={},d=new WeakMap,p=[],_=null,v=!1,m=null,f=null,A=null,b=null,S=null,L=null,R=null,C=new kt(0,0,0),F=0,T=!1,y=null,I=null,tt=null,X=null,et=null,Rt.set(0,0,n.canvas.width,n.canvas.height),q.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:gt,disable:Ct,bindFramebuffer:Yt,drawBuffers:Pt,useProgram:ue,setBlending:M,setMaterial:it,setFlipSided:Y,setCullFace:K,setLineWidth:Z,setPolygonOffset:ot,setScissorTest:j,activeTexture:x,bindTexture:g,unbindTexture:D,compressedTexImage2D:z,compressedTexImage3D:k,texImage2D:xt,texImage3D:wt,updateUBOMapping:Nt,uniformBlockBinding:zt,texStorage2D:It,texStorage3D:lt,texSubImage2D:V,texSubImage3D:dt,compressedTexSubImage2D:at,compressedTexSubImage3D:mt,scissor:Ut,viewport:_t,reset:oe}}function TM(n,t,e,i,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ot,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(x,g){return p?new OffscreenCanvas(x,g):tr("canvas")}function v(x,g,D){let z=1;const k=j(x);if((k.width>D||k.height>D)&&(z=D/Math.max(k.width,k.height)),z<1)if(typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&x instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&x instanceof ImageBitmap||typeof VideoFrame<"u"&&x instanceof VideoFrame){const V=Math.floor(z*k.width),dt=Math.floor(z*k.height);h===void 0&&(h=_(V,dt));const at=g?_(V,dt):h;return at.width=V,at.height=dt,at.getContext("2d").drawImage(x,0,0,V,dt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+k.width+"x"+k.height+") to ("+V+"x"+dt+")."),at}else return"data"in x&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+k.width+"x"+k.height+")."),x;return x}function m(x){return x.generateMipmaps}function f(x){n.generateMipmap(x)}function A(x){return x.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:x.isWebGL3DRenderTarget?n.TEXTURE_3D:x.isWebGLArrayRenderTarget||x.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(x,g,D,z,k=!1){if(x!==null){if(n[x]!==void 0)return n[x];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+x+"'")}let V=g;if(g===n.RED&&(D===n.FLOAT&&(V=n.R32F),D===n.HALF_FLOAT&&(V=n.R16F),D===n.UNSIGNED_BYTE&&(V=n.R8)),g===n.RED_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.R8UI),D===n.UNSIGNED_SHORT&&(V=n.R16UI),D===n.UNSIGNED_INT&&(V=n.R32UI),D===n.BYTE&&(V=n.R8I),D===n.SHORT&&(V=n.R16I),D===n.INT&&(V=n.R32I)),g===n.RG&&(D===n.FLOAT&&(V=n.RG32F),D===n.HALF_FLOAT&&(V=n.RG16F),D===n.UNSIGNED_BYTE&&(V=n.RG8)),g===n.RG_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RG8UI),D===n.UNSIGNED_SHORT&&(V=n.RG16UI),D===n.UNSIGNED_INT&&(V=n.RG32UI),D===n.BYTE&&(V=n.RG8I),D===n.SHORT&&(V=n.RG16I),D===n.INT&&(V=n.RG32I)),g===n.RGB_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RGB8UI),D===n.UNSIGNED_SHORT&&(V=n.RGB16UI),D===n.UNSIGNED_INT&&(V=n.RGB32UI),D===n.BYTE&&(V=n.RGB8I),D===n.SHORT&&(V=n.RGB16I),D===n.INT&&(V=n.RGB32I)),g===n.RGBA_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RGBA8UI),D===n.UNSIGNED_SHORT&&(V=n.RGBA16UI),D===n.UNSIGNED_INT&&(V=n.RGBA32UI),D===n.BYTE&&(V=n.RGBA8I),D===n.SHORT&&(V=n.RGBA16I),D===n.INT&&(V=n.RGBA32I)),g===n.RGB&&D===n.UNSIGNED_INT_5_9_9_9_REV&&(V=n.RGB9_E5),g===n.RGBA){const dt=k?so:qt.getTransfer(z);D===n.FLOAT&&(V=n.RGBA32F),D===n.HALF_FLOAT&&(V=n.RGBA16F),D===n.UNSIGNED_BYTE&&(V=dt===ne?n.SRGB8_ALPHA8:n.RGBA8),D===n.UNSIGNED_SHORT_4_4_4_4&&(V=n.RGBA4),D===n.UNSIGNED_SHORT_5_5_5_1&&(V=n.RGB5_A1)}return(V===n.R16F||V===n.R32F||V===n.RG16F||V===n.RG32F||V===n.RGBA16F||V===n.RGBA32F)&&t.get("EXT_color_buffer_float"),V}function S(x,g){let D;return x?g===null||g===Ci||g===_s?D=n.DEPTH24_STENCIL8:g===zn?D=n.DEPTH32F_STENCIL8:g===Qs&&(D=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ci||g===_s?D=n.DEPTH_COMPONENT24:g===zn?D=n.DEPTH_COMPONENT32F:g===Qs&&(D=n.DEPTH_COMPONENT16),D}function L(x,g){return m(x)===!0||x.isFramebufferTexture&&x.minFilter!==pn&&x.minFilter!==Sn?Math.log2(Math.max(g.width,g.height))+1:x.mipmaps!==void 0&&x.mipmaps.length>0?x.mipmaps.length:x.isCompressedTexture&&Array.isArray(x.image)?g.mipmaps.length:1}function R(x){const g=x.target;g.removeEventListener("dispose",R),F(g),g.isVideoTexture&&u.delete(g)}function C(x){const g=x.target;g.removeEventListener("dispose",C),y(g)}function F(x){const g=i.get(x);if(g.__webglInit===void 0)return;const D=x.source,z=d.get(D);if(z){const k=z[g.__cacheKey];k.usedTimes--,k.usedTimes===0&&T(x),Object.keys(z).length===0&&d.delete(D)}i.remove(x)}function T(x){const g=i.get(x);n.deleteTexture(g.__webglTexture);const D=x.source,z=d.get(D);delete z[g.__cacheKey],o.memory.textures--}function y(x){const g=i.get(x);if(x.depthTexture&&(x.depthTexture.dispose(),i.remove(x.depthTexture)),x.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(g.__webglFramebuffer[z]))for(let k=0;k<g.__webglFramebuffer[z].length;k++)n.deleteFramebuffer(g.__webglFramebuffer[z][k]);else n.deleteFramebuffer(g.__webglFramebuffer[z]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[z])}else{if(Array.isArray(g.__webglFramebuffer))for(let z=0;z<g.__webglFramebuffer.length;z++)n.deleteFramebuffer(g.__webglFramebuffer[z]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let z=0;z<g.__webglColorRenderbuffer.length;z++)g.__webglColorRenderbuffer[z]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[z]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const D=x.textures;for(let z=0,k=D.length;z<k;z++){const V=i.get(D[z]);V.__webglTexture&&(n.deleteTexture(V.__webglTexture),o.memory.textures--),i.remove(D[z])}i.remove(x)}let I=0;function tt(){I=0}function X(){const x=I;return x>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+x+" texture units while this GPU supports only "+s.maxTextures),I+=1,x}function et(x){const g=[];return g.push(x.wrapS),g.push(x.wrapT),g.push(x.wrapR||0),g.push(x.magFilter),g.push(x.minFilter),g.push(x.anisotropy),g.push(x.internalFormat),g.push(x.format),g.push(x.type),g.push(x.generateMipmaps),g.push(x.premultiplyAlpha),g.push(x.flipY),g.push(x.unpackAlignment),g.push(x.colorSpace),g.join()}function st(x,g){const D=i.get(x);if(x.isVideoTexture&&Z(x),x.isRenderTargetTexture===!1&&x.version>0&&D.__version!==x.version){const z=x.image;if(z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(D,x,g);return}}e.bindTexture(n.TEXTURE_2D,D.__webglTexture,n.TEXTURE0+g)}function $(x,g){const D=i.get(x);if(x.version>0&&D.__version!==x.version){q(D,x,g);return}e.bindTexture(n.TEXTURE_2D_ARRAY,D.__webglTexture,n.TEXTURE0+g)}function Q(x,g){const D=i.get(x);if(x.version>0&&D.__version!==x.version){q(D,x,g);return}e.bindTexture(n.TEXTURE_3D,D.__webglTexture,n.TEXTURE0+g)}function H(x,g){const D=i.get(x);if(x.version>0&&D.__version!==x.version){rt(D,x,g);return}e.bindTexture(n.TEXTURE_CUBE_MAP,D.__webglTexture,n.TEXTURE0+g)}const ft={[io]:n.REPEAT,[yi]:n.CLAMP_TO_EDGE,[Va]:n.MIRRORED_REPEAT},Et={[pn]:n.NEAREST,[Ym]:n.NEAREST_MIPMAP_NEAREST,[dr]:n.NEAREST_MIPMAP_LINEAR,[Sn]:n.LINEAR,[No]:n.LINEAR_MIPMAP_NEAREST,[bi]:n.LINEAR_MIPMAP_LINEAR},ut={[Jm]:n.NEVER,[s_]:n.ALWAYS,[Qm]:n.LESS,[gf]:n.LEQUAL,[t_]:n.EQUAL,[i_]:n.GEQUAL,[e_]:n.GREATER,[n_]:n.NOTEQUAL};function ht(x,g){if(g.type===zn&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Sn||g.magFilter===No||g.magFilter===dr||g.magFilter===bi||g.minFilter===Sn||g.minFilter===No||g.minFilter===dr||g.minFilter===bi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(x,n.TEXTURE_WRAP_S,ft[g.wrapS]),n.texParameteri(x,n.TEXTURE_WRAP_T,ft[g.wrapT]),(x===n.TEXTURE_3D||x===n.TEXTURE_2D_ARRAY)&&n.texParameteri(x,n.TEXTURE_WRAP_R,ft[g.wrapR]),n.texParameteri(x,n.TEXTURE_MAG_FILTER,Et[g.magFilter]),n.texParameteri(x,n.TEXTURE_MIN_FILTER,Et[g.minFilter]),g.compareFunction&&(n.texParameteri(x,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(x,n.TEXTURE_COMPARE_FUNC,ut[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===pn||g.minFilter!==dr&&g.minFilter!==bi||g.type===zn&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const D=t.get("EXT_texture_filter_anisotropic");n.texParameterf(x,D.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function Rt(x,g){let D=!1;x.__webglInit===void 0&&(x.__webglInit=!0,g.addEventListener("dispose",R));const z=g.source;let k=d.get(z);k===void 0&&(k={},d.set(z,k));const V=et(g);if(V!==x.__cacheKey){k[V]===void 0&&(k[V]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,D=!0),k[V].usedTimes++;const dt=k[x.__cacheKey];dt!==void 0&&(k[x.__cacheKey].usedTimes--,dt.usedTimes===0&&T(g)),x.__cacheKey=V,x.__webglTexture=k[V].texture}return D}function q(x,g,D){let z=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(z=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(z=n.TEXTURE_3D);const k=Rt(x,g),V=g.source;e.bindTexture(z,x.__webglTexture,n.TEXTURE0+D);const dt=i.get(V);if(V.version!==dt.__version||k===!0){e.activeTexture(n.TEXTURE0+D);const at=qt.getPrimaries(qt.workingColorSpace),mt=g.colorSpace===ei?null:qt.getPrimaries(g.colorSpace),It=g.colorSpace===ei||at===mt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,It);let lt=v(g.image,!1,s.maxTextureSize);lt=ot(g,lt);const xt=r.convert(g.format,g.colorSpace),wt=r.convert(g.type);let Ut=b(g.internalFormat,xt,wt,g.colorSpace,g.isVideoTexture);ht(z,g);let _t;const Nt=g.mipmaps,zt=g.isVideoTexture!==!0,oe=dt.__version===void 0||k===!0,N=V.dataReady,Mt=L(g,lt);if(g.isDepthTexture)Ut=S(g.format===gs,g.type),oe&&(zt?e.texStorage2D(n.TEXTURE_2D,1,Ut,lt.width,lt.height):e.texImage2D(n.TEXTURE_2D,0,Ut,lt.width,lt.height,0,xt,wt,null));else if(g.isDataTexture)if(Nt.length>0){zt&&oe&&e.texStorage2D(n.TEXTURE_2D,Mt,Ut,Nt[0].width,Nt[0].height);for(let J=0,nt=Nt.length;J<nt;J++)_t=Nt[J],zt?N&&e.texSubImage2D(n.TEXTURE_2D,J,0,0,_t.width,_t.height,xt,wt,_t.data):e.texImage2D(n.TEXTURE_2D,J,Ut,_t.width,_t.height,0,xt,wt,_t.data);g.generateMipmaps=!1}else zt?(oe&&e.texStorage2D(n.TEXTURE_2D,Mt,Ut,lt.width,lt.height),N&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,lt.width,lt.height,xt,wt,lt.data)):e.texImage2D(n.TEXTURE_2D,0,Ut,lt.width,lt.height,0,xt,wt,lt.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){zt&&oe&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Mt,Ut,Nt[0].width,Nt[0].height,lt.depth);for(let J=0,nt=Nt.length;J<nt;J++)if(_t=Nt[J],g.format!==hn)if(xt!==null)if(zt){if(N)if(g.layerUpdates.size>0){const bt=yu(_t.width,_t.height,g.format,g.type);for(const yt of g.layerUpdates){const Vt=_t.data.subarray(yt*bt/_t.data.BYTES_PER_ELEMENT,(yt+1)*bt/_t.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,yt,_t.width,_t.height,1,xt,Vt)}g.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,0,_t.width,_t.height,lt.depth,xt,_t.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,J,Ut,_t.width,_t.height,lt.depth,0,_t.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else zt?N&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,J,0,0,0,_t.width,_t.height,lt.depth,xt,wt,_t.data):e.texImage3D(n.TEXTURE_2D_ARRAY,J,Ut,_t.width,_t.height,lt.depth,0,xt,wt,_t.data)}else{zt&&oe&&e.texStorage2D(n.TEXTURE_2D,Mt,Ut,Nt[0].width,Nt[0].height);for(let J=0,nt=Nt.length;J<nt;J++)_t=Nt[J],g.format!==hn?xt!==null?zt?N&&e.compressedTexSubImage2D(n.TEXTURE_2D,J,0,0,_t.width,_t.height,xt,_t.data):e.compressedTexImage2D(n.TEXTURE_2D,J,Ut,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):zt?N&&e.texSubImage2D(n.TEXTURE_2D,J,0,0,_t.width,_t.height,xt,wt,_t.data):e.texImage2D(n.TEXTURE_2D,J,Ut,_t.width,_t.height,0,xt,wt,_t.data)}else if(g.isDataArrayTexture)if(zt){if(oe&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Mt,Ut,lt.width,lt.height,lt.depth),N)if(g.layerUpdates.size>0){const J=yu(lt.width,lt.height,g.format,g.type);for(const nt of g.layerUpdates){const bt=lt.data.subarray(nt*J/lt.data.BYTES_PER_ELEMENT,(nt+1)*J/lt.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,nt,lt.width,lt.height,1,xt,wt,bt)}g.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,lt.width,lt.height,lt.depth,xt,wt,lt.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Ut,lt.width,lt.height,lt.depth,0,xt,wt,lt.data);else if(g.isData3DTexture)zt?(oe&&e.texStorage3D(n.TEXTURE_3D,Mt,Ut,lt.width,lt.height,lt.depth),N&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,lt.width,lt.height,lt.depth,xt,wt,lt.data)):e.texImage3D(n.TEXTURE_3D,0,Ut,lt.width,lt.height,lt.depth,0,xt,wt,lt.data);else if(g.isFramebufferTexture){if(oe)if(zt)e.texStorage2D(n.TEXTURE_2D,Mt,Ut,lt.width,lt.height);else{let J=lt.width,nt=lt.height;for(let bt=0;bt<Mt;bt++)e.texImage2D(n.TEXTURE_2D,bt,Ut,J,nt,0,xt,wt,null),J>>=1,nt>>=1}}else if(Nt.length>0){if(zt&&oe){const J=j(Nt[0]);e.texStorage2D(n.TEXTURE_2D,Mt,Ut,J.width,J.height)}for(let J=0,nt=Nt.length;J<nt;J++)_t=Nt[J],zt?N&&e.texSubImage2D(n.TEXTURE_2D,J,0,0,xt,wt,_t):e.texImage2D(n.TEXTURE_2D,J,Ut,xt,wt,_t);g.generateMipmaps=!1}else if(zt){if(oe){const J=j(lt);e.texStorage2D(n.TEXTURE_2D,Mt,Ut,J.width,J.height)}N&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,xt,wt,lt)}else e.texImage2D(n.TEXTURE_2D,0,Ut,xt,wt,lt);m(g)&&f(z),dt.__version=V.version,g.onUpdate&&g.onUpdate(g)}x.__version=g.version}function rt(x,g,D){if(g.image.length!==6)return;const z=Rt(x,g),k=g.source;e.bindTexture(n.TEXTURE_CUBE_MAP,x.__webglTexture,n.TEXTURE0+D);const V=i.get(k);if(k.version!==V.__version||z===!0){e.activeTexture(n.TEXTURE0+D);const dt=qt.getPrimaries(qt.workingColorSpace),at=g.colorSpace===ei?null:qt.getPrimaries(g.colorSpace),mt=g.colorSpace===ei||dt===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,mt);const It=g.isCompressedTexture||g.image[0].isCompressedTexture,lt=g.image[0]&&g.image[0].isDataTexture,xt=[];for(let nt=0;nt<6;nt++)!It&&!lt?xt[nt]=v(g.image[nt],!0,s.maxCubemapSize):xt[nt]=lt?g.image[nt].image:g.image[nt],xt[nt]=ot(g,xt[nt]);const wt=xt[0],Ut=r.convert(g.format,g.colorSpace),_t=r.convert(g.type),Nt=b(g.internalFormat,Ut,_t,g.colorSpace),zt=g.isVideoTexture!==!0,oe=V.__version===void 0||z===!0,N=k.dataReady;let Mt=L(g,wt);ht(n.TEXTURE_CUBE_MAP,g);let J;if(It){zt&&oe&&e.texStorage2D(n.TEXTURE_CUBE_MAP,Mt,Nt,wt.width,wt.height);for(let nt=0;nt<6;nt++){J=xt[nt].mipmaps;for(let bt=0;bt<J.length;bt++){const yt=J[bt];g.format!==hn?Ut!==null?zt?N&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt,0,0,yt.width,yt.height,Ut,yt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt,Nt,yt.width,yt.height,0,yt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):zt?N&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt,0,0,yt.width,yt.height,Ut,_t,yt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt,Nt,yt.width,yt.height,0,Ut,_t,yt.data)}}}else{if(J=g.mipmaps,zt&&oe){J.length>0&&Mt++;const nt=j(xt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,Mt,Nt,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(lt){zt?N&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,xt[nt].width,xt[nt].height,Ut,_t,xt[nt].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Nt,xt[nt].width,xt[nt].height,0,Ut,_t,xt[nt].data);for(let bt=0;bt<J.length;bt++){const Vt=J[bt].image[nt].image;zt?N&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt+1,0,0,Vt.width,Vt.height,Ut,_t,Vt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt+1,Nt,Vt.width,Vt.height,0,Ut,_t,Vt.data)}}else{zt?N&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,Ut,_t,xt[nt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Nt,Ut,_t,xt[nt]);for(let bt=0;bt<J.length;bt++){const yt=J[bt];zt?N&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt+1,0,0,Ut,_t,yt.image[nt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,bt+1,Nt,Ut,_t,yt.image[nt])}}}m(g)&&f(n.TEXTURE_CUBE_MAP),V.__version=k.version,g.onUpdate&&g.onUpdate(g)}x.__version=g.version}function pt(x,g,D,z,k,V){const dt=r.convert(D.format,D.colorSpace),at=r.convert(D.type),mt=b(D.internalFormat,dt,at,D.colorSpace),It=i.get(g),lt=i.get(D);if(lt.__renderTarget=g,!It.__hasExternalTextures){const xt=Math.max(1,g.width>>V),wt=Math.max(1,g.height>>V);k===n.TEXTURE_3D||k===n.TEXTURE_2D_ARRAY?e.texImage3D(k,V,mt,xt,wt,g.depth,0,dt,at,null):e.texImage2D(k,V,mt,xt,wt,0,dt,at,null)}e.bindFramebuffer(n.FRAMEBUFFER,x),K(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,z,k,lt.__webglTexture,0,Y(g)):(k===n.TEXTURE_2D||k>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&k<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,z,k,lt.__webglTexture,V),e.bindFramebuffer(n.FRAMEBUFFER,null)}function gt(x,g,D){if(n.bindRenderbuffer(n.RENDERBUFFER,x),g.depthBuffer){const z=g.depthTexture,k=z&&z.isDepthTexture?z.type:null,V=S(g.stencilBuffer,k),dt=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,at=Y(g);K(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,at,V,g.width,g.height):D?n.renderbufferStorageMultisample(n.RENDERBUFFER,at,V,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,V,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,dt,n.RENDERBUFFER,x)}else{const z=g.textures;for(let k=0;k<z.length;k++){const V=z[k],dt=r.convert(V.format,V.colorSpace),at=r.convert(V.type),mt=b(V.internalFormat,dt,at,V.colorSpace),It=Y(g);D&&K(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,It,mt,g.width,g.height):K(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,It,mt,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,mt,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ct(x,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,x),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const z=i.get(g.depthTexture);z.__renderTarget=g,(!z.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),st(g.depthTexture,0);const k=z.__webglTexture,V=Y(g);if(g.depthTexture.format===us)K(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,k,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,k,0);else if(g.depthTexture.format===gs)K(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,k,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,k,0);else throw new Error("Unknown depthTexture format")}function Yt(x){const g=i.get(x),D=x.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==x.depthTexture){const z=x.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),z){const k=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,z.removeEventListener("dispose",k)};z.addEventListener("dispose",k),g.__depthDisposeCallback=k}g.__boundDepthTexture=z}if(x.depthTexture&&!g.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");Ct(g.__webglFramebuffer,x)}else if(D){g.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[z]),g.__webglDepthbuffer[z]===void 0)g.__webglDepthbuffer[z]=n.createRenderbuffer(),gt(g.__webglDepthbuffer[z],x,!1);else{const k=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,V=g.__webglDepthbuffer[z];n.bindRenderbuffer(n.RENDERBUFFER,V),n.framebufferRenderbuffer(n.FRAMEBUFFER,k,n.RENDERBUFFER,V)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),gt(g.__webglDepthbuffer,x,!1);else{const z=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,z,n.RENDERBUFFER,k)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function Pt(x,g,D){const z=i.get(x);g!==void 0&&pt(z.__webglFramebuffer,x,x.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),D!==void 0&&Yt(x)}function ue(x){const g=x.texture,D=i.get(x),z=i.get(g);x.addEventListener("dispose",C);const k=x.textures,V=x.isWebGLCubeRenderTarget===!0,dt=k.length>1;if(dt||(z.__webglTexture===void 0&&(z.__webglTexture=n.createTexture()),z.__version=g.version,o.memory.textures++),V){D.__webglFramebuffer=[];for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer[at]=[];for(let mt=0;mt<g.mipmaps.length;mt++)D.__webglFramebuffer[at][mt]=n.createFramebuffer()}else D.__webglFramebuffer[at]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){D.__webglFramebuffer=[];for(let at=0;at<g.mipmaps.length;at++)D.__webglFramebuffer[at]=n.createFramebuffer()}else D.__webglFramebuffer=n.createFramebuffer();if(dt)for(let at=0,mt=k.length;at<mt;at++){const It=i.get(k[at]);It.__webglTexture===void 0&&(It.__webglTexture=n.createTexture(),o.memory.textures++)}if(x.samples>0&&K(x)===!1){D.__webglMultisampledFramebuffer=n.createFramebuffer(),D.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let at=0;at<k.length;at++){const mt=k[at];D.__webglColorRenderbuffer[at]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,D.__webglColorRenderbuffer[at]);const It=r.convert(mt.format,mt.colorSpace),lt=r.convert(mt.type),xt=b(mt.internalFormat,It,lt,mt.colorSpace,x.isXRRenderTarget===!0),wt=Y(x);n.renderbufferStorageMultisample(n.RENDERBUFFER,wt,xt,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,D.__webglColorRenderbuffer[at])}n.bindRenderbuffer(n.RENDERBUFFER,null),x.depthBuffer&&(D.__webglDepthRenderbuffer=n.createRenderbuffer(),gt(D.__webglDepthRenderbuffer,x,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(V){e.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture),ht(n.TEXTURE_CUBE_MAP,g);for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0)for(let mt=0;mt<g.mipmaps.length;mt++)pt(D.__webglFramebuffer[at][mt],x,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,mt);else pt(D.__webglFramebuffer[at],x,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);m(g)&&f(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(dt){for(let at=0,mt=k.length;at<mt;at++){const It=k[at],lt=i.get(It);e.bindTexture(n.TEXTURE_2D,lt.__webglTexture),ht(n.TEXTURE_2D,It),pt(D.__webglFramebuffer,x,It,n.COLOR_ATTACHMENT0+at,n.TEXTURE_2D,0),m(It)&&f(n.TEXTURE_2D)}e.unbindTexture()}else{let at=n.TEXTURE_2D;if((x.isWebGL3DRenderTarget||x.isWebGLArrayRenderTarget)&&(at=x.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(at,z.__webglTexture),ht(at,g),g.mipmaps&&g.mipmaps.length>0)for(let mt=0;mt<g.mipmaps.length;mt++)pt(D.__webglFramebuffer[mt],x,g,n.COLOR_ATTACHMENT0,at,mt);else pt(D.__webglFramebuffer,x,g,n.COLOR_ATTACHMENT0,at,0);m(g)&&f(at),e.unbindTexture()}x.depthBuffer&&Yt(x)}function w(x){const g=x.textures;for(let D=0,z=g.length;D<z;D++){const k=g[D];if(m(k)){const V=A(x),dt=i.get(k).__webglTexture;e.bindTexture(V,dt),f(V),e.unbindTexture()}}}const P=[],M=[];function it(x){if(x.samples>0){if(K(x)===!1){const g=x.textures,D=x.width,z=x.height;let k=n.COLOR_BUFFER_BIT;const V=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,dt=i.get(x),at=g.length>1;if(at)for(let mt=0;mt<g.length;mt++)e.bindFramebuffer(n.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+mt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,dt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+mt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,dt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,dt.__webglFramebuffer);for(let mt=0;mt<g.length;mt++){if(x.resolveDepthBuffer&&(x.depthBuffer&&(k|=n.DEPTH_BUFFER_BIT),x.stencilBuffer&&x.resolveStencilBuffer&&(k|=n.STENCIL_BUFFER_BIT)),at){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,dt.__webglColorRenderbuffer[mt]);const It=i.get(g[mt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,It,0)}n.blitFramebuffer(0,0,D,z,0,0,D,z,k,n.NEAREST),l===!0&&(P.length=0,M.length=0,P.push(n.COLOR_ATTACHMENT0+mt),x.depthBuffer&&x.resolveDepthBuffer===!1&&(P.push(V),M.push(V),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,M)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,P))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),at)for(let mt=0;mt<g.length;mt++){e.bindFramebuffer(n.FRAMEBUFFER,dt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+mt,n.RENDERBUFFER,dt.__webglColorRenderbuffer[mt]);const It=i.get(g[mt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,dt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+mt,n.TEXTURE_2D,It,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,dt.__webglMultisampledFramebuffer)}else if(x.depthBuffer&&x.resolveDepthBuffer===!1&&l){const g=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function Y(x){return Math.min(s.maxSamples,x.samples)}function K(x){const g=i.get(x);return x.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Z(x){const g=o.render.frame;u.get(x)!==g&&(u.set(x,g),x.update())}function ot(x,g){const D=x.colorSpace,z=x.format,k=x.type;return x.isCompressedTexture===!0||x.isVideoTexture===!0||D!==vs&&D!==ei&&(qt.getTransfer(D)===ne?(z!==hn||k!==kn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),g}function j(x){return typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement?(c.width=x.naturalWidth||x.width,c.height=x.naturalHeight||x.height):typeof VideoFrame<"u"&&x instanceof VideoFrame?(c.width=x.displayWidth,c.height=x.displayHeight):(c.width=x.width,c.height=x.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=tt,this.setTexture2D=st,this.setTexture2DArray=$,this.setTexture3D=Q,this.setTextureCube=H,this.rebindTextures=Pt,this.setupRenderTarget=ue,this.updateRenderTargetMipmap=w,this.updateMultisampleRenderTarget=it,this.setupDepthRenderbuffer=Yt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=K}function AM(n,t){function e(i,s=ei){let r;const o=qt.getTransfer(s);if(i===kn)return n.UNSIGNED_BYTE;if(i===kl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Wl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===cf)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===af)return n.BYTE;if(i===lf)return n.SHORT;if(i===Qs)return n.UNSIGNED_SHORT;if(i===Gl)return n.INT;if(i===Ci)return n.UNSIGNED_INT;if(i===zn)return n.FLOAT;if(i===sr)return n.HALF_FLOAT;if(i===uf)return n.ALPHA;if(i===hf)return n.RGB;if(i===hn)return n.RGBA;if(i===ff)return n.LUMINANCE;if(i===df)return n.LUMINANCE_ALPHA;if(i===us)return n.DEPTH_COMPONENT;if(i===gs)return n.DEPTH_STENCIL;if(i===pf)return n.RED;if(i===Xl)return n.RED_INTEGER;if(i===mf)return n.RG;if(i===jl)return n.RG_INTEGER;if(i===ql)return n.RGBA_INTEGER;if(i===kr||i===Wr||i===Xr||i===jr)if(o===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===kr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===jr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===kr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Wr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Xr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===jr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ga||i===ka||i===Wa||i===Xa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Ga)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ka)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Wa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Xa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ja||i===qa||i===Ya)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===ja||i===qa)return o===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Ya)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Ka||i===$a||i===Za||i===Ja||i===Qa||i===tl||i===el||i===nl||i===il||i===sl||i===rl||i===ol||i===al||i===ll)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Ka)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===$a)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Za)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Ja)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Qa)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===tl)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===el)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===nl)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===il)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===sl)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===rl)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ol)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===al)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ll)return o===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===qr||i===cl||i===ul)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===qr)return o===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===cl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ul)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===_f||i===hl||i===fl||i===dl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===qr)return r.COMPRESSED_RED_RGTC1_EXT;if(i===hl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===fl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===dl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===_s?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const wM=`
void main() {
